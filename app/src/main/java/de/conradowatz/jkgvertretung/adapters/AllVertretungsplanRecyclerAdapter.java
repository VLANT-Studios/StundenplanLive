...
public class AllVertretungsplanRecyclerAdapter extends RecyclerView.Adapter<AllVertretungsplanRecyclerAdapter.ViewHolder> {
    ...
    public AllVertretungsplanRecyclerAdapter(int position) {
    ...
    public void updateData() {
        ...
        new AsyncTask<Boolean, Integer, List<Stunde>>() {
            ...
            protected List<Stunde> doInBackground(Boolean... params) {
                ...
                return tmpOnlineTag.getSortedVertretung();
            }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (viewType == VIEWTYPE_HEADER) {
            ...
            holder.kursText.setVisibility(View.VISIBLE);
            String klasse = stunde.getKlasse().getName();
            if (stunde.getKurs()!=null) klasse += ": "+stunde.getKurs().getBezeichnung();
            holder.kursText.setText(klasse);
