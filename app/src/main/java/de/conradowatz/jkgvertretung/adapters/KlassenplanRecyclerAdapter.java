...
public class KlassenplanRecyclerAdapter extends RecyclerView.Adapter<KlassenplanRecyclerAdapter.ViewHolder> {
    ...
    public KlassenplanRecyclerAdapter(int  position, String klassenName) {
    ...
    public void updateData() {
        ...
        new AsyncTask<Boolean, Integer, List<Stunde>>() {
            ...
            protected List<Stunde> doInBackground(Boolean... params) {
                ...
                Klasse klasse = Klasse.getKlasse(klassenName);
                long klassenId = klasse!=null?klasse.getId():-1;
                return tmpOnlineTag.getSortedStunden(klassenId);
            }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (viewType == VIEWTYPE_HEADER) {
            ...
            holder.textText.setText("Für diesen Tag wurden keine Stunden gefunden.");
